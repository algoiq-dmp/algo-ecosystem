# Delta XI — Installation Guide

**Version:** 3.2.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Installation Steps

This guide covers installing Delta XI v3.2.0 on **ALGO IQ 4** (192.168.190.104).
...
```bash
git clone git@gitlab.internal:algo-iq/delta-xi.git
cd delta-xi
git checkout v3.2.0
```
...
# Expected response:
# {"status":"healthy","version":"3.2.0","uptime_seconds":15}
```
...
# Verify registration:
curl http://192.168.190.104:3100/api/v1/registry/delta-xi
```
