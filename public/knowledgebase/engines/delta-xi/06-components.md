# Delta XI — Internal Components

**Version:** 3.2.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Component Architecture

Delta XI is composed of the following internal modules, each with a distinct responsibility within the Layer 2 - Opportunity Generation ecosystem.

## Core Modules

| Module | Role | Responsibility |
|--------|------|---------------|
| `delta-xi-scanner` | Primary engine | Core business logic and computation pipeline |
| `delta-xi-signals` | API gateway | REST endpoint exposure, rate limiting, request validation |
| `delta-xi-api` | Analytics/Processing | Data processing, transformation, and enrichment |
...
### 2. API Gateway
- Exposes REST endpoints on ports `3020`
