...
Planned enhancements for Delta XI beyond v3.2.0.
...
Roadmap suggestions and feature requests should be submitted via Jira project `DELTA-XI` or discussed in Slack `#delta-xi-feedback`.
