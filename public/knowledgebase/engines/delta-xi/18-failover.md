# Delta XI — Failover & High Availability

**Version:** 3.2.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## HA Architecture

Delta XI maintains 99.7% uptime through redundant deployment and automated failover mechanisms.
...
### Instance Recovery
```bash
narad restart delta-xi --instance 1 --graceful
```
...
# Manual override:
narad failover-db delta-xi --target standby-algo-iq-4
```

### Full Service Recovery
```bash
narad restore delta-xi --from-backup --backup-date latest
```
...
### DR Activation
```bash
narad dr-activate delta-xi --site dr-mumbai
```
