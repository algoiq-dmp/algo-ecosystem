...
```mermaid
graph LR
    A[Ganesh OHLC] -->|REST| B[Delta XI Core]
...
5. **Publication:** Results pushed to MQ topic `delta-xi.output` and exposed via REST

## Output Distribution

- **REST APIs** on ports `3020` serve downstream consumers with pagination support
