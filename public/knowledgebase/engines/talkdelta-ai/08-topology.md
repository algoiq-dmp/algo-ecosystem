# TalkDelta AI — Ecosystem Topology

**Version:** 1.4.0 | **Owner:** AI/ML | **Last Updated:** 2026-07-25

## Ecosystem Position

TalkDelta AI operates within **Layer 2 - Opportunity Generation** on server **ALGO IQ 4** (`192.168.190.104`).
...
│  ┌──────────┐    ┌──────────────┐    ┌───────────┐ │
│  │  Ganesh  │───→│              │───→│ Consumers │ │
│  │   MQ     │───→│ TalkDelta AI │───→│  Kuber Alpha, DXCC... │ │
│  │  Surya   │───→│              │    └───────────┘ │
│  │ Lakshmi  │───→│  v1.4.0    │                   │
│  └──────────┘    └──────────────┘                   │
└─────────────────────────────────────────────────────┘
...
|----------|------|-----------|---------|
| REST | 3010 | Bidirectional | API serving and data ingestion |
