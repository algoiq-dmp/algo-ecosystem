# TalkDelta AI — Failover & High Availability

**Version:** 1.4.0 | **Owner:** AI/ML | **Last Updated:** 2026-07-25

## HA Architecture

TalkDelta AI maintains 99.5% uptime through redundant deployment and automated failover mechanisms.
...
### Instance Recovery
```bash
narad restart talkdelta-ai --instance 1 --graceful
```
...
# Manual override:
narad failover-db talkdelta-ai --target standby-algo-iq-4
```

### Full Service Recovery
```bash
narad restore talkdelta-ai --from-backup --backup-date latest
```
...
### DR Activation
```bash
narad dr-activate talkdelta-ai --site dr-mumbai
```
