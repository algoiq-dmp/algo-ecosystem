# TalkDelta AI — Testing Strategy

**Version:** 1.4.0 | **Owner:** AI/ML | **Last Updated:** 2026-07-25

## Test Plan

TalkDelta AI follows a comprehensive testing strategy validated through **Parikshak** testing engine.
...
- **Location:** `talkdelta-ai/tests/unit/`
- **Run:** Every commit via CI pipeline
- **Time:** < 2 minutes for full suite

### 2. Component Tests
- **Scope:** Each module (`talkdelta-ai-engine, talkdelta-ai-ml, talkdelta-ai-api`) tested in isolation
...
Before any release, TalkDelta AI must pass Parikshak certification:

```
parikshak certify talkdelta-ai --version 1.4.0 --env staging
...
test:
  stage: test
  script:
    - parikshak run-unit --target talkdelta-ai
    - parikshak run-component --target talkdelta-ai
    - parikshak security-scan --target talkdelta-ai
  only:
    - merge_requests
    - main
```
