# TalkDelta AI — Monitoring & Alerting

**Version:** 1.4.0 | **Owner:** AI/ML | **Last Updated:** 2026-07-25

## Health Monitoring

TalkDelta AI health is monitored at 99.5% uptime via Narad heartbeat checks every 5 seconds.
...
```prometheus
# Service health
talkdelta-ai_up{instance="192.168.190.104:3010"} 1

# Request metrics
talkdelta-ai_http_requests_total{method="GET", endpoint="/api/v1/health", status="200"}
talkdelta-ai_http_request_duration_seconds{quantile="0.99"}

# Processing metrics
talkdelta-ai_messages_processed_total
talkdelta-ai_processing_duration_seconds{quantile="0.95"}
talkdelta-ai_cache_hit_ratio
```
...
|-----------|-----|---------|
| Service Overview | `/d/talkdelta-ai-overview` | Health, latency, error rates |
| API Insights | `/d/talkdelta-ai-api` | Endpoint usage, rate limiting |
| MQ Consumer | `/d/talkdelta-ai-mq` | Message processing, lag, DLQ |
| Resource Usage | `/d/talkdelta-ai-resources` | CPU, memory, disk, network |
...
- P99 latency > 500ms for 5+ minutes → Slack #eng-ai-ml
