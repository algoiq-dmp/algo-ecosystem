# TalkDelta AI — Security Architecture

**Version:** 1.4.0 | **Owner:** AI/ML | **Last Updated:** 2026-07-25

## Security Overview

TalkDelta AI security is managed by **Suraksha** (Security Layer), providing authentication, authorization, encryption, RBAC, and audit logging for all API access.

## Authentication

All requests to TalkDelta AI must include a valid JWT token:
