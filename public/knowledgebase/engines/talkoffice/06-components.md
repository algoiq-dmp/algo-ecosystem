# TalkOffice — Internal Components

**Version:** 4.0.0 | **Owner:** Operations | **Last Updated:** 2026-07-25

## Component Architecture

TalkOffice is composed of the following internal modules, each with a distinct responsibility within the Operations & Business ecosystem.

## Core Modules

| Module | Role | Responsibility |
|--------|------|---------------|
| `talkoffice-oms` | Primary engine | Core business logic and computation pipeline |
| `talkoffice-rms` | API gateway | REST endpoint exposure, rate limiting, request validation |
| `talkoffice-dashboard` | Analytics/Processing | Data processing, transformation, and enrichment |
...
### 2. API Gateway
- Exposes REST endpoints on ports `3080`
...
- Publishes computed results to MQ for downstream consumers: DXCC, Chitragupta
