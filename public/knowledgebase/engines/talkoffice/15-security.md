# TalkOffice — Security Architecture

**Version:** 4.0.0 | **Owner:** Operations | **Last Updated:** 2026-07-25

## Security Overview

TalkOffice security is managed by **Suraksha** (Security Layer), providing authentication, authorization, encryption, RBAC, and audit logging for all API access.

## Authentication

All requests to TalkOffice must include a valid JWT token:
