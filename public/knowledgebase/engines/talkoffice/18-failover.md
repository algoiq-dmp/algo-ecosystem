# TalkOffice — Failover & High Availability

**Version:** 4.0.0 | **Owner:** Operations | **Last Updated:** 2026-07-25

## HA Architecture

TalkOffice maintains 99.9% uptime through redundant deployment and automated failover mechanisms.
...
### Instance Recovery
```bash
narad restart talkoffice --instance 1 --graceful
```
...
# Manual override:
narad failover-db talkoffice --target standby-algo-iq-19
```

### Full Service Recovery
```bash
narad restore talkoffice --from-backup --backup-date latest
```
...
### DR Activation
```bash
narad dr-activate talkoffice --site dr-mumbai
```
