# SpreadWatch — Security Architecture

**Version:** 2.8.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Security Overview

SpreadWatch security is managed by **Suraksha** (Security Layer), providing authentication, authorization, encryption, RBAC, and audit logging for all API access.

## Authentication

All requests to SpreadWatch must include a valid JWT token:
