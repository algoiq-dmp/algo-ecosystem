...
Planned enhancements for SpreadWatch beyond v2.8.0.
...
Roadmap suggestions and feature requests should be submitted via Jira project `SPREADWATCH` or discussed in Slack `#spreadwatch-feedback`.
