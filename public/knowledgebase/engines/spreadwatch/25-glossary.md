# SpreadWatch — Glossary

**Version:** 2.8.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Terminology Reference

Key terms used throughout SpreadWatch documentation and operations.

### A

**API Gateway:** The public-facing REST interface component (`spreadwatch-api`) that handles authentication, rate limiting, and request routing.
...
**Docker Compose:** Tool used for defining and running multi-container SpreadWatch deployments with a single configuration file.
...
**gRPC:** High-performance RPC framework used for internal inter-module communication within SpreadWatch.
...
**Webhook:** HTTP callback mechanism where SpreadWatch sends POST requests to registered subscriber URLs on data change events.
