# SpreadWatch — Ecosystem Topology

**Version:** 2.8.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Ecosystem Position

SpreadWatch operates within **Operations & Business** on server **ALGO IQ 4** (`192.168.190.104`).
...
│  ┌──────────┐    ┌──────────────┐    ┌───────────┐ │
│  │  Ganesh  │───→│              │───→│ Consumers │ │
│  │   MQ     │───→│ SpreadWatch  │───→│  Kuber Alpha, DXCC... │ │
│  │  Surya   │───→│              │    └───────────┘ │
│  │ Lakshmi  │───→│  v2.8.0    │                   │
│  └──────────┘    └──────────────┘                   │
└─────────────────────────────────────────────────────┘
...
|----------|------|-----------|---------|
| REST | 3022 | Bidirectional | API serving and data ingestion |
