# SpreadWatch — Internal Components

**Version:** 2.8.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Component Architecture

SpreadWatch is composed of the following internal modules, each with a distinct responsibility within the Operations & Business ecosystem.

## Core Modules

| Module | Role | Responsibility |
|--------|------|---------------|
| `spreadwatch-engine` | Primary engine | Core business logic and computation pipeline |
| `spreadwatch-api` | API gateway | REST endpoint exposure, rate limiting, request validation |
...
### 2. API Gateway
- Exposes REST endpoints on ports `3022`
