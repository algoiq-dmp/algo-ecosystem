# TalkDelta — Monitoring & Alerting

**Version:** 5.1.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Health Monitoring

TalkDelta health is monitored at 99.8% uptime via Narad heartbeat checks every 5 seconds.
...
```prometheus
# Service health
talkdelta_up{instance="192.168.190.104:3005"} 1

# Request metrics
talkdelta_http_requests_total{method="GET", endpoint="/api/v1/health", status="200"}
talkdelta_http_request_duration_seconds{quantile="0.99"}

# Processing metrics
talkdelta_messages_processed_total
talkdelta_processing_duration_seconds{quantile="0.95"}
talkdelta_cache_hit_ratio
```
...
|-----------|-----|---------|
| Service Overview | `/d/talkdelta-overview` | Health, latency, error rates |
| API Insights | `/d/talkdelta-api` | Endpoint usage, rate limiting |
| MQ Consumer | `/d/talkdelta-mq` | Message processing, lag, DLQ |
| Resource Usage | `/d/talkdelta-resources` | CPU, memory, disk, network |
