# TalkDelta — Internal Components

**Version:** 5.1.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Component Architecture

TalkDelta is composed of the following internal modules, each with a distinct responsibility within the Operations & Business ecosystem.

## Core Modules

| Module | Role | Responsibility |
|--------|------|---------------|
| `talkdelta-dashboard` | Primary engine | Core business logic and computation pipeline |
| `talkdelta-analytics` | API gateway | REST endpoint exposure, rate limiting, request validation |
| `talkdelta-api` | Analytics/Processing | Data processing, transformation, and enrichment |
| `talkdelta-stream` | Data streaming | Real-time data streaming and WebSocket management |
...
### 2. API Gateway
- Exposes REST endpoints on ports `3005, 3006`
...
- Publishes computed results to MQ for downstream consumers: TalkDelta AI, Kavach, Chitragupta, Simulator, Kuber Alpha, Strategy Factory, Delta XI, VYUH, SpreadWatch, Rakshak
