# TalkDelta — Security Architecture

**Version:** 5.1.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Security Overview

TalkDelta security is managed by **Suraksha** (Security Layer), providing authentication, authorization, encryption, RBAC, and audit logging for all API access.

## Authentication

All requests to TalkDelta must include a valid JWT token:
