# VYUH — Security Architecture

**Version:** 3.0.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Security Overview

VYUH security is managed by **Suraksha** (Security Layer), providing authentication, authorization, encryption, RBAC, and audit logging for all API access.

## Authentication

All requests to VYUH must include a valid JWT token:
