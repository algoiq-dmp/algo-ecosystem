# VYUH — Failover & High Availability

**Version:** 3.0.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## HA Architecture

VYUH maintains 99.6% uptime through redundant deployment and automated failover mechanisms.
...
### Instance Recovery
```bash
narad restart vyuh --instance 1 --graceful
```
...
# Manual override:
narad failover-db vyuh --target standby-algo-iq-4
```

### Full Service Recovery
```bash
narad restore vyuh --from-backup --backup-date latest
```
...
### DR Activation
```bash
narad dr-activate vyuh --site dr-mumbai
```
