# VYUH — Ecosystem Topology

**Version:** 3.0.0 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Ecosystem Position

VYUH operates within **Layer 2 - Opportunity Generation** on server **ALGO IQ 4** (`192.168.190.104`).
...
|----------|------|-----------|---------|
| REST | 3021 | Bidirectional | API serving and data ingestion |
