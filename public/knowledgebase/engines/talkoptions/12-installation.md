# TalkOptions Platform — Installation Guide

**Version:** 4.7.2 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Installation Steps

This guide covers installing TalkOptions Platform v4.7.2 on **ALGO IQ 18** (192.168.190.118).

## Prerequisites

- Docker 24.0+ with Docker Compose v2
- Access to ALGO IQ 18 (192.168.190.118)
- Narad service running on port 3100
- Suraksha authentication token (obtain from Infra team)
- Database instances: PostgreSQL, InfluxDB provisioned and accessible
- Minimum 8 GB RAM, 4 CPU cores, 50 GB disk

## Step 1: Clone Repository

```bash
git clone git@gitlab.internal:algo-iq/talkoptions.git
cd talkoptions
git checkout v4.7.2
```
...
# Expected response:
# {"status":"healthy","version":"4.7.2","uptime_seconds":15}
```
...
# Verify registration:
curl http://192.168.190.118:3100/api/v1/registry/talkoptions
```
