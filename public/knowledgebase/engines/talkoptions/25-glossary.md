# TalkOptions Platform — Glossary

**Version:** 4.7.2 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Terminology Reference

Key terms used throughout TalkOptions Platform documentation and operations.

### A

**API Gateway:** The public-facing REST interface component (`talkoptions-api`) that handles authentication, rate limiting, and request routing.
...
**Docker Compose:** Tool used for defining and running multi-container TalkOptions Platform deployments with a single configuration file.
...
**gRPC:** High-performance RPC framework used for internal inter-module communication within TalkOptions Platform.
...
**Webhook:** HTTP callback mechanism where TalkOptions Platform sends POST requests to registered subscriber URLs on data change events.
