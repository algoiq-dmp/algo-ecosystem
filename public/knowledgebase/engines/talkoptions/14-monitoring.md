# TalkOptions Platform — Monitoring & Alerting

**Version:** 4.7.2 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Health Monitoring

TalkOptions Platform health is monitored at 99.8% uptime via Narad heartbeat checks every 5 seconds.
...
```prometheus
# Service health
talkoptions_up{instance="192.168.190.118:8081"} 1

# Request metrics
talkoptions_http_requests_total{method="GET", endpoint="/api/v1/health", status="200"}
talkoptions_http_request_duration_seconds{quantile="0.99"}

# Processing metrics
talkoptions_messages_processed_total
talkoptions_processing_duration_seconds{quantile="0.95"}
talkoptions_cache_hit_ratio
```
...
|-----------|-----|---------|
| Service Overview | `/d/talkoptions-overview` | Health, latency, error rates |
| API Insights | `/d/talkoptions-api` | Endpoint usage, rate limiting |
| MQ Consumer | `/d/talkoptions-mq` | Message processing, lag, DLQ |
| Resource Usage | `/d/talkoptions-resources` | CPU, memory, disk, network |
