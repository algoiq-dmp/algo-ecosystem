# TalkOptions Platform — Testing Strategy

**Version:** 4.7.2 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Test Plan

TalkOptions Platform follows a comprehensive testing strategy validated through **Parikshak** testing engine.
...
- **Location:** `talkoptions/tests/unit/`
- **Run:** Every commit via CI pipeline
- **Time:** < 2 minutes for full suite

### 2. Component Tests
- **Scope:** Each module (`talkoptions-core, talkoptions-api, talkoptions-analytics`) tested in isolation
...
Before any release, TalkOptions Platform must pass Parikshak certification:

```
parikshak certify talkoptions --version 4.7.2 --env staging
...
test:
  stage: test
  script:
    - parikshak run-unit --target talkoptions
    - parikshak run-component --target talkoptions
    - parikshak security-scan --target talkoptions
  only:
    - merge_requests
    - main
```
