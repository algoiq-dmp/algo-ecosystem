# TalkOptions Platform — Suraksha Integration

**Version:** 4.7.2 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## Suraksha Security Integration

TalkOptions Platform integrates with **Suraksha** (Security Layer) for all authentication, authorization, and audit capabilities.
...
```
Client → TalkOptions Platform API → Suraksha /auth/verify → Validate JWT → Grant/Deny
```

1. Client includes `Authorization: Bearer <token>` header
2. TalkOptions Platform extracts JWT and calls Suraksha `/auth/verify`
3. Suraksha validates token signature, expiry, and revocation status
4. Response includes user identity and role claims
5. TalkOptions Platform enforces RBAC based on role claims
...
TalkOptions Platform retrieves sensitive configuration from Suraksha Vault at startup:
...
| Event | Suraksha Action | TalkOptions Platform Response |
|-------|----------------|-------------------|
