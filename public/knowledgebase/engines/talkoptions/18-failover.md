# TalkOptions Platform — Failover & High Availability

**Version:** 4.7.2 | **Owner:** Analytics | **Last Updated:** 2026-07-25

## HA Architecture

TalkOptions Platform maintains 99.8% uptime through redundant deployment and automated failover mechanisms.
...
### Instance Recovery
```bash
narad restart talkoptions --instance 1 --graceful
```
...
# Manual override:
narad failover-db talkoptions --target standby-algo-iq-18
```

### Full Service Recovery
```bash
narad restore talkoptions --from-backup --backup-date latest
```
...
### DR Activation
```bash
narad dr-activate talkoptions --site dr-mumbai
```
