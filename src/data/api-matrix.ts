...
export const apiMatrix: ApiMatrixEntry[] = [
  {
    ...
    authMethod: 'X-API-KEY + X-CLIENT-CODE (dual auth)',
    baseUrl: 'http://192.168.190.120:9191',
    version: '1.2.0',
  },
  {
    sr: 2,
    ...
    authMethod: 'Bearer Token (JWT) + x-bypass',
    baseUrl: 'http://192.168.190.120:9081',
    version: '1.0',
  },
  {
    sr: 3,
    ...
    authMethod: 'x-bypass header',
    baseUrl: 'https://webapi.talkoptions.in',
    version: '279 endpoints',
  },
  {
    sr: 4,
    ...
    authMethod: 'JWT Bearer (public indicator endpoints)',
    baseUrl: 'http://localhost:8060',
    version: '2.0.0 (105 indicators)',
  },
  {
    sr: 5,
  ...
  },
  {
    ...
    authMethod: 'None (localhost)',
    baseUrl: 'http://localhost:5000',
    version: 'Prime (Portfolio/VAR/TradeTrail)',
  },
  {
    sr: 8,
    ...
    authMethod: 'JWT Bearer (HS256, 12hr)',
    baseUrl: 'http://localhost:50000',
    version: 'ZeroMQ + LiteDB',
  },
  {
    sr: 9,
  ...
  },
  {
    ...
    authMethod: 'Query param token',
    baseUrl: 'wss://wssreact.talkoptions.in',
    version: 'Level 1 + Level 2 feeds',
  },
  {
    sr: 12,
