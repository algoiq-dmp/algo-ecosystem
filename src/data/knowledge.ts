...
export const knowledgeBase: KnowledgeBaseEntry[] = [
  ...
  },
  {
    ...
    documents: [
      { title: 'TalkDelta AI Reasoning Engine - Business Requirements Specification', type: 'BRS', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta-ai/brs-reasoning-engine' },
      { title: 'TalkDelta AI - System Requirements Specification', type: 'SRS', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta-ai/srs' },
      { title: 'TalkDelta AI Architecture - High-Level Design', type: 'HLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta-ai/hld' },
      { title: 'TalkDelta AI Hedge Suggestion Engine - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta-ai/lld-hedge-suggestions' },
      { title: 'TalkDelta AI Delta Rebalance Recommender - Low-Level Design', type: 'LLD', status: 'in-progress', url: 'https://docs.algoiq.internal/kb/talkdelta-ai/lld-rebalancer' },
      { title: 'TalkDelta AI API Reference (Analytics Consumption)', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta-ai/api-analytics-consume' },
      { title: 'TalkDelta AI Natural-Language Explanation Engine', type: 'LLD', status: 'in-progress', url: 'https://docs.algoiq.internal/kb/talkdelta-ai/lld-nlp' },
      { title: 'TalkDelta AI Strategy Health Scoring Model', type: 'KB', status: 'draft', url: 'https://docs.algoiq.internal/kb/talkdelta-ai/kb-health-scoring' },
      { title: 'TalkDelta AI v2.0.0-beta Release Notes', type: 'RELEASE', status: 'in-progress', url: 'https://docs.algoiq.internal/kb/talkdelta-ai/release-2.0.0' }
    ]
  },
  {
    id: 'KB-005',
  ...
  },
  {
    ...
    entityName: 'Suchak',
    documents: [
      { title: 'Suchak SIC-001 - Strategy Driven Calculation Architecture', type: 'BRS', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/brs-sic001-architecture' },
      { title: 'Suchak SIC-001 - System Requirements Specification', type: 'SRS', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/srs-sic001' },
      { title: 'Suchak Strategy Instruction & Calculation Service - High-Level Design', type: 'HLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/hld-strategy-instruction' },
      { title: 'Suchak Calculation Engine Library - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/lld-calculation-engine' },
      { title: 'Suchak Requirement Consolidation Engine - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/lld-requirement-consolidation' },
      { title: 'Suchak Runtime Calculation Scheduler - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/lld-runtime-scheduler' },
      { title: 'Kubera Strategy Instruction API Reference', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/api-kubera-instruction' },
      { title: 'Suchak Response API Reference v1', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/api-response-v1' },
      { title: 'Ganesh API Integration Guide for Suchak', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/kb-ganesh-integration' },
      { title: 'Surya BOD Integration Guide for Suchak', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/kb-surya-integration' },
      { title: 'OHLC Synchronization Rules & Best Practices', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/kb-ohlc-sync' },
      { title: 'Calculation Scheduling Rules & Optimization', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/kb-scheduling' },
      { title: 'Dashboard Field Dictionary - Suchak Runtime Monitoring', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/kb-dashboard-fields' },
      { title: 'Runtime State Definitions & Transitions', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/kb-runtime-states' },
      { title: 'Suchak Database Schema (Strategy Instructions, Calculation Cache, Audit Log)', type: 'DB_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/db-schema' },
      { title: 'Suchak API Key Authentication & mTLS Guide', type: 'DEPLOY', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/deploy-security' },
      { title: 'Suchak Error Handling & Recovery Procedures', type: 'TROUBLESHOOT', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/troubleshooting' },
      { title: 'Suchak v5.0.0 Release Notes - SIC-001 Architecture', type: 'RELEASE', status: 'in-progress', url: 'https://docs.algoiq.internal/kb/suchak/release-5.0.0' },
      { title: 'Suchak Acceptance Criteria & Validation Test Plan', type: 'TEST', status: 'in-progress', url: 'https://docs.algoiq.internal/kb/suchak/test-acceptance' },
      { title: 'Suchak Audit Trail Design & Compliance Requirements', type: 'HLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/suchak/hld-audit' }
    ]
  },
  {
    id: 'KB-008',
    ...
    entityName: 'Kavach',
    documents: [
      { title: 'Kavach Delta Risk Protection Engine - Business Requirements Specification', type: 'BRS', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/brs-delta-risk-protection' },
      { title: 'Kavach Delta Risk Protection - System Requirements Specification', type: 'SRS', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/srs-delta-risk' },
      { title: 'Kavach Delta Risk Protection Architecture - High-Level Design', type: 'HLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/hld-architecture' },
      { title: 'Kavach Range Evaluation Engine - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/lld-range-evaluator' },
      { title: 'Kavach Alert Generation & Delivery Pipeline - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/lld-alert-pipeline' },
      { title: 'Kavach Heartbeat Monitoring System - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/lld-heartbeat' },
      { title: 'Kavach Strategy Registration & Parameter Management API Reference', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/api-strategy-registration' },
      { title: 'Kavach Alert Callback API Reference', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/api-alert-callback' },
      { title: 'Kavach Health Check & Settings API Reference', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/api-health-settings' },
      { title: 'Kavach Database Schema (9 Tables)', type: 'DB_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/db-schema' },
      { title: 'Kavach PostgreSQL Deployment & Partitioning Guide', type: 'DEPLOY', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/deploy-postgresql' },
      { title: 'Kavach TalkDelta Integration & Connectivity Guide', type: 'INSTALL', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/install-talkdelta-integration' },
      { title: 'Kavach Surya BOD Integration Guide', type: 'INSTALL', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/install-surya-bod' },
      { title: 'Kavach Dashboard Design & Operations Guide', type: 'USER', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/user-dashboard' },
      { title: 'Kavach Risk Manager Configuration Guide', type: 'ADMIN', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/admin-risk-config' },
      { title: 'Kavach Alert Configuration & Threshold Tuning Guide', type: 'ADMIN', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/admin-alert-config' },
      { title: 'Kavach Strategy Onboarding & Certification Checklist', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/kb-strategy-onboarding' },
      { title: 'Kavach Troubleshooting & Incident Response Guide', type: 'TROUBLESHOOT', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/troubleshooting' },
      { title: 'Kavach v3.5.0 Release Notes - Delta Risk Protection Architecture', type: 'RELEASE', status: 'in-progress', url: 'https://docs.algoiq.internal/kb/kavach/release-3.5.0' },
      { title: 'Kavach UAT & Production Readiness Checklist', type: 'TEST', status: 'complete', url: 'https://docs.algoiq.internal/kb/kavach/test-uat-checklist' }
    ]
  },
  {
    id: 'KB-009',
  ...
  },
  {
    ...
    documents: [
      { title: 'TalkDelta Real-Time Derivatives Analytics Engine - Business Requirements', type: 'BRS', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/brs-analytics-engine' },
      { title: 'TalkDelta Beta Architecture - System Requirements Specification', type: 'SRS', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/srs-beta' },
      { title: 'TalkDelta Analytics Engine - High-Level Design', type: 'HLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/hld' },
      { title: 'TalkDelta Greeks Engine - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/lld-greeks' },
      { title: 'TalkDelta Internal Contract Master Service - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/lld-contract-master' },
      { title: 'TalkDelta Internal Margin Engine - Low-Level Design', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/lld-margin' },
      { title: 'TalkDelta Lakshmi Integration (Market Data Ingestion)', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/lld-lakshmi' },
      { title: 'TalkDelta Vega Integration (Trade & Position Feed)', type: 'LLD', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/lld-vega' },
      { title: 'TalkDelta API Reference (REST + WebSocket)', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/api' },
      { title: 'TalkDelta Kavach Integration Guide', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/kb-kavach' },
      { title: 'TalkDelta TalkDelta AI Integration Guide', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/kb-ai' },
      { title: 'TalkDelta Database Schema', type: 'DB_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/talkdelta/db' },
      { title: 'TalkDelta v6.0.0-beta Release Notes', type: 'RELEASE', status: 'in-progress', url: 'https://docs.algoiq.internal/kb/talkdelta/release-6.0.0' }
    ]
  },
  {
    id: 'KB-038',
  ...
  },
  {
    ...
    documents: [
      { title: 'API Documentation Index & Governance Matrix', type: 'KB', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/governance-matrix' },
      ...
      { title: 'Ganesh Broadcast API (OHLC) - v1.0', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/ganesh-broadcast-api' },
      { title: 'Suchak Engine REST API - v2.0 (105 Indicators)', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/suchak-engine-api' },
      { title: 'Surya External Engine API - v1.2.0 (57 Endpoints)', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/surya-external-api' },
      { title: 'TalkDelta Prime API (Portfolio, VAR, Trade Trail)', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/talkdelta-prime-api' },
      { title: 'TalkOptions API (279 Endpoints)', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/talkoptions-api' },
      { title: 'WebSocket Integration Guide (Level 1/2 Feeds)', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/websocket-guide' },
      { title: 'Vega TalkStrategy API Reference (ZeroMQ)', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/vega-talkstrategy-api' },
      { title: 'Vega TalkStrategy Dashboard Guide', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/vega-talkstrategy-dashboard' },
      { title: 'Vega TalkStrategy Postman Collection', type: 'API_DOC', status: 'complete', url: 'https://docs.algoiq.internal/kb/api-registry/vega-postman' },
