...
export interface Connection {
  ...
  source: string;
  target: string;
  type: 'market-data' | 'order' | 'trade-confirmation' | 'ohlc' | 'signal' | 'calculation-response' | 'strategy-instruction' | 'delta-risk' | 'delta-risk-alert' | 'analytics-feed' | 'risk' | 'ai' | 'audit' | 'monitoring' | 'api-call' | 'mq-broadcast';
